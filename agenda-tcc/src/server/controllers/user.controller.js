...
const operacoes = {
    ...
    mostrarFilho: async (req, res) => {
        try {
            ...
            const filhos = await Usuario.findAll({
                ...
                attributes: ["id", "usuario", "pontos", "status"]
            });
            res.json(filhos);
        } catch (error) {
            console.error(error);
    ...
    mostrarFilhosAtivos: async (req, res) => {
        try {
            const paiId = req.usuario.id;
            const filhos = await Usuario.findAll({
                where: {
    ...
    desativar: async (req, res) => {
        try {
            ...
            console.log("Filho vindo do front", filhoId);
            ...
            return res.json({ message: "Filho desativado com sucesso." });
        } catch (error) {
            console.error(error);
